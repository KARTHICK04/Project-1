...
<h1 style="font-family:monotype corsiva; color:#000000;" ><b> PRODUCT</b></h1>
	...
	<form:form action="${addAction}" method="post" enctype="multipart/form-data" commandName="product">
		<table style="width:100%">
			...
			<td><form:input type="file" name="image" path="image" style="color:black;" height= "50 pixel" width= "50 pixel"/></td>
		...
		<table class="table table-bordered">
			...
			<c:forEach items="${productList}" var="product">
				<tr>
					...
					<td><img src="<c:url value="${product.imageUrl}"/>" style="width:500px;height:500px"></td>

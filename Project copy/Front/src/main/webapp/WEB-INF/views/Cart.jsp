        ...
        <table class="table table-bordered" style="font-family:monotype corsiva;color:black;font-size: 1.5em;" >
		  <thead>
			...
			<tbody>
				...
				<td>
							<img src="{{items.imageUrl}}" style="width:75px;height:75px" />
						</td>
						...
						<button class="btn btn-danger btnAction" ng-click="removeItemFromCart(items.cartItemId)">
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (cartItemId) {
         ...
         $http['delete']('http://localhost:8081/memoryfd/categoryDropdown/productDisplay/usercart/cart/removeItem/'+cartItemId).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8081/memoryfd/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8081/memoryfd/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8081/memoryfd/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });

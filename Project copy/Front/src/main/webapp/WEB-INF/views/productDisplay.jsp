...
<title>memorycard-ProductDisplay</title>
<style>
div{
...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead">MEMORY CARD</p>
                <div class="list-group">
                    <a href="categoryDropdown/101" class="list-group-item">Samsung</a>
                    <a href="categoryDropdown/102" class="list-group-item">Sandisk</a>
                    <a href="categoryDropdown/103" class="list-group-item">Sony</a>
                </div>
            </div>
   <div class="col-md-9">
...
<img src="${product.imageUrl}" class="img-responsive"  height="300px" width="300px" />
...
<a href="categoryback"><button type="button" class="btn btn-primary" >back to categories</button></a>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (id) {
         ...
         $http['delete']('http://localhost:8081/memoryfd/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8081/memoryfd/categoryDropdown/productDisplay/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8081/memoryfd/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8081/memoryfd/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });

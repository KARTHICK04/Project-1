...
<footer class="container-fluid text-center">
 <div class="row1">
    ...
    <div class="col-sm-6" style="background-color:lavender;"><span class="glyphicon glyphicon-envelope"> <b>mail</b>:public@memorycard.in</span> </div>
...
<a href="www.google pluse.com"><i class="fa fa-google-plus"> </i></a>    
  </div>
</footer>
</body>
</html>